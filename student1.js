...
var students = [
    new Student("001", "Michelle Osborne", new Programme("001", "Software Engineering")), 
    new Student("002", "Zabrina Osborne", new Programme("002", "Computing")), 
    new Student("003", "Clayton Osborne", new Programme("003", "Physics"))];
